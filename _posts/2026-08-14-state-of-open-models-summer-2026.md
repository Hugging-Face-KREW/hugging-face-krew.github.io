...
image: assets/images/blog/posts/2026-08-14-state-of-open-models-summer-2026/thumbnail.png
authors:
  - user: AdinaY
  - user: multimodalart
  - user: irenesolaiman
slug: "state-of-open-models-summer-2026"
...
{:toc}
<!--toc-->
_이 글은 Hugging Face 블로그의 [State of Open Models: Summer 2026 Observations](https://huggingface.co/blog/state-of-open-models-summer-2026)를 한국어로 번역한 글입니다._
...
AI 세계에서 시간은 압축된 느낌이다. 우리의 [spring report](https://huggingface.co/blog/huggingface/state-of-os-hf-spring-2026)이 생태계를 살펴본 연 2회 분석 이후 불과 몇 달이 지났고, 이번 여름까지 관찰한 여러 발견들이 있다. 이 보고서는 2026년 1월부터 8월까지의 관찰을 제시하고 각 관찰 뒤의 데이터를 제시한다.
...
Hugging Face Hub의 모델과 데이터셋은 매일 증가하고 있다. 공개 모델 저장소는 기간 동안 2.43 to 2.96 million으로 증가했고, 데이터셋은 711,000에서 1 million으로, Spaces는 1.00에서 1.44 million으로 증가했다. 아래의 분포는 여전히 극단적이며, 대략 85.6%의 모델이 lifetimesDownloads가 200 미만이고, 저장소의 1.5%가 모든 다운로드의 99.2%를 차지한다. 아래의 모든 내용은 그 형태 안에서 일어난다.

**1\\. The frontier is moving fast**

**과거에는 명확한 발전 경로가 있었다: 연구소들은 작고 가벼운 모델을 먼저 공개하고 점차 규모의 상단으로 진행했다. 2026년에는 다수의 중국 연구소가 이 발전 과정을 완전히 건너뛰었다.**
...
## **2\\. Attention ≠ Adoption** {#section-1}
...
## **3\\. Open weights shift where value accumulates** {#section-2}
...
## **4\\. Qwen has become the community's base model** {#section-3}
...
## **5\\. Small models remain the practical layer** {#section-4}
...
## **6\\. Agents are the new user** {#section-5}
